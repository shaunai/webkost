            ...
            <section class="room-detail-section">
                <div class="room-detail-header">
                    <div class="room-detail-images">
                        <img src="{{ asset('images/kost1.png') }}" alt="Kamar {{ $kamar->nomor_kamar }}" class="room-main-image">
                    ...
                    <div class="room-detail-info">
                        ...
                        <div class="room-price">Rp {{ number_format($kamar->harga, 0, ',', '.') }} <span>/ Per Bulan</span></div>
                ...
                <div class="room-detail-body">
                    ...
                    <p>Kamar {{ $kamar->nomor_kamar }} adalah kamar {{ strtolower($kamar->tipe_kamar) }} dengan fasilitas lengkap, cocok untuk mahasiswa dan pekerja. Lokasi strategis, lingkungan nyaman, dan keamanan 24 jam.</p>
                </div>
                <div class="room-detail-recommend">
                    <h3>Tipe Kamar Lainnya</h3>
                    <div class="recommend-cards">
                        @foreach(\App\Models\Kamar::where('id', '!=', $kamar->id)->limit(2)->get() as $lain)
                        <div class="room-card">
